...
Abra a página de Releases e baixe `FFXMusic-Setup-1.0.exe`. O instalador inclui o runtime e as ferramentas de áudio e requer permissão de administrador. O destino padrão é `C:\Program Files\FFX Apps\FFX Music`. Ao desinstalar, a pasta compartilhada `FFX Apps` é preservada.
...
Os instaladores ficam nos anexos de **Releases**, e não em commits Git. O código está em `ffx-music-source`. A versão pública permanece 1.0; as tags `v1.0.0.N` identificam cada revisão para o verificador de atualizações.
